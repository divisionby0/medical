...
/*
		...
		$this->_json_request_types = array(
			'email_support' => sprintf( __( 'Less than 15 Minute EmailSender Support Response %s', 'w3-total-cache' ), '(M-F 9AM - 5PM EDT): $175 USD' ),
		...
		$this->_request_types = array(
			'email_support' => sprintf( __( 'Less than 15 Minute EmailSender Support Response %s', 'w3-total-cache' ), '<br /><span>(M-F 9AM - 5PM EDT): $175 USD</span>' ),
