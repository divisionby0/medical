...
/*
define('WPMS_ON', true);
define('WPMS_MAIL_FROM', 'From EmailSender');
...
<pre><?php echo $smtp_debug ?></pre>
	...
	?>
<div class="wrap">
<h2><?php _e('Advanced EmailSender Options', 'wp_mail_smtp'); ?></h2>
<form method="post" action="options.php">
<?php wp_nonce_field('email-options'); ?>

<table class="optiontable form-table">
<tr valign="top">
<th scope="row"><label for="mail_from"><?php _e('From EmailSender', 'wp_mail_smtp'); ?></label></th>
...
<?php _e('Set the return-path to match the From EmailSender'); ?></label>
</fieldset></td>
</tr>
</table>
...
<h3><?php _e('Send a Test EmailSender', 'wp_mail_smtp'); ?></h3>
...
function wp_mail_smtp_menus() {
	...
	if (function_exists('add_submenu_page')) {
		add_options_page(__('Advanced EmailSender Options', 'wp_mail_smtp'),__('EmailSender', 'wp_mail_smtp'),'manage_options',__FILE__,'wp_mail_smtp_options_page');
	}
